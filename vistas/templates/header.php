      ...
      <header>
        ...
        <div class="w3-top">
          <div class="w3-bar w3-blue w3-card w3-left-align w3-large">
            ...
            <a onclick="document.getElementById('id02').style.display='block'" style="float:right" href="/tpfinal-basededatos/controladores/logout.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-red">Cerrar Sesión</a>
          </div>
