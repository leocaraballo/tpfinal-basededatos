<div class="w3-container w3-light-grey" style="padding:128px 16px;">
  <h1 class="">Nuevo Lote</h1>
  <form action="/tpfinal-basededatos/controladores/lotes.php" method="POST">
    <div class="w3-section">
      <label class="" for="numero"><strong>Número de Lote:</strong></label>
      ...
      <label class="" for="fecha_emision"><strong>Fecha de Emisión:</strong></label>
      ...
      <label class="" for="fecha_vcto"><strong>Fecha de Vencimiento:</strong></label>
      <input class="w3-input w3-margin-bottom" type="date" name="fecha_vcto" id="fecha_vcto">
      <label class="" for="cantidad"><strong>Cantidad:</strong></label>
